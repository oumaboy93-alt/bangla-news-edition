...
function generateHtmlPitch(agencyName, category) {
  ...
  <div style="font-family: 'Noto Sans Bengali', sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #e2e8f0; border-radius: 12px; background-color: #ffffff;">
    ...
    <p><a href="https://bangla-news-edition-bd.netlify.app/#/desk/probashi-bangla-news" style="display: inline-block; background-color: #047857; color: white; padding: 10px 20px; text-decoration: none; border-radius: 6px; font-weight: bold;">🌐 প্রবাস নিউজ ডেস্ক দেখুন</a></p>
